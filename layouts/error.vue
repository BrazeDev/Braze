<template>
  <main class="container">
    ...
    <span class="particle 0">0</span>
    <span class="particle 0">0</span>
    <span v-if="error.statusCode === 404" class="particle 4">4</span>
    <span v-if="error.statusCode === 404" class="particle 4">4</span>
    <span v-if="error.statusCode === 404" class="particle 4">4</span>
    <span v-if="error.statusCode === 404" class="particle 4">4</span>
    <span v-if="error.statusCode === 404" class="particle 4">4</span>
    ...
    <span v-if="error.statusCode === 404" class="particle 4">4</span>
    <span v-if="error.statusCode === 404" class="particle 4">4</span>
    <span v-if="error.statusCode > 499" class="particle 5">5</span>
    <span v-if="error.statusCode > 499" class="particle 5">5</span>
    <span v-if="error.statusCode > 499" class="particle 5">5</span>
    <span v-if="error.statusCode > 499" class="particle 5">5</span>
    <span v-if="error.statusCode > 499" class="particle 5">5</span>
    ...
    <article class="content">
      ...
      <p v-if="error.statusCode === 404">
        Lots of <strong>404</strong>s, but no page.
      </p>
      <p v-else>
...
.content {
  ...
  opacity: 0;
  animation: slidein 0.8s 1.2s cubic-bezier(0.39, 0.575, 0.28, 0.995) forwards;
